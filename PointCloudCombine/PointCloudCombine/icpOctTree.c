...
//#define DELTA_THRESHOLD 0.00001f
...
//		if((*_modelPair = closestPntToPnt(_model, _data, &distance)) == NULL)
//			return -1;//something bad happened in tree
//		avrDistance += distance;
//	}
//	end = time(NULL);
//	timespend = difftime(end,start);
//	return avrDistance/icp->maxModelPairs;
//}
//
...
//
//	icp->model = (octTreeNode*)malloc(sizeof(octTreeNode));
